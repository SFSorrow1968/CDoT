# DOT Translation System

## Quick Reference

- **Group ID**: `DOT_Options` (must NOT match mod name `DOT`)
- **ID format**: `DOT_Options.SomethingHere`
...
| Problem | Solution |
|---------|----------|
| Mod name cut off/unclickable | Ensure groupId is `DOT_Options`, not `DOT` |
