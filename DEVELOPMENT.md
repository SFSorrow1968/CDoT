# BDOT Development Reference (Agent-Only)
...
## ModOptions System
- Options live in `Configuration/BDOTModOptions.cs` as a **public static** class.
...
- `Configuration/BDOTModOptions.cs`: UI options + zone accessors.
- `Configuration/BodyZone.cs`: Zone enum and constants.
- `Core/BDOTModule.cs`: ThunderScript entry.
