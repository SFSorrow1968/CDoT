        ...
        public static void CheckAndSyncProfileMultipliers()
        {
            try
            {
                ...
                if (currentProfile != _lastKnownProfile)
                {
                    ...
                    if (DebugLogging)
                        Debug.Log("[DOT] Profile changed to: " + currentProfile);
                    ...
                    if (currentProfile == ProfilePreset.BleedOnly)
                    {
                        ...
                        if (DebugLogging)
                            Debug.Log("[DOT] Setting elemental multipliers to 0x for Bleed Only profile");
                        FireMultiplier = 0f;
                    ...
                    else if (currentProfile == ProfilePreset.ElementalOnly)
                    {
                        ...
                        if (DebugLogging)
                            Debug.Log("[DOT] Setting physical multipliers to 0x for Elemental Only profile");
                        PierceMultiplier = 0f;
                        SlashMultiplier = 0f;
                    }
            ...
            {
                Debug.LogError("[DOT] Error in CheckAndSyncProfileMultipliers: " + ex.Message);
            }
        }
